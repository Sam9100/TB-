...
<body style="background-image: url(image/background\ presensi.jpg);" class="bg-cover bg-center bg-fixed">
    ...
    <p id="tabelPresensi" class="font-semibold text-lg">Total Hadir: <span id="totalHadir">0</span></p>
    <p id="tabelPresensi" class="font-semibold text-lg">Total Alpa: <span id="totalAlpa">0</span></p>
    <p id="tabelPresensi" class="font-semibold text-lg">Total Izin: <span id="totalIzin">0</span></p>
    <script>
        var totalHadir = 0;
        var totalAlpa = 0;
        var totalIzin = 0;
        ...
        function updateCount() {
            totalHadir = document.querySelectorAll('.hadir').length;
            totalAlpa = document.querySelectorAll('.alpa').length;
            totalIzin = document.querySelectorAll('.izin').length;
            document.getElementById('totalHadir').innerText = totalHadir;
            document.getElementById('totalAlpa').innerText = totalAlpa;
